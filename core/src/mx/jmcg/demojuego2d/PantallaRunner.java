...
public class PantallaRunner extends Pantalla
{
    ...
    private void crearAudio() {
        ...
        manager.load("marioBros.mp3", Music.class);  // programa la carga
        ...
        efectoSalto = manager.get("moneda.mp3");
    ...
    private void crearHUD() {
        ...
        skin.add("fondo", new Texture("BotonesMenu/fondoPad.png"));
        skin.add("boton", new Texture("BotonesMenu/botonPad.png"));
    ...
    private void crearBolasFuego() {
        texturaBolaFuego = new Texture("bolaFuego.png");
